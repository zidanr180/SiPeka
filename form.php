...
<title>SiPeka | Admin Form Ketinggian Air</title>
...
<p>Sipeka | Form Ketinggian Air
    ...
    <div>
        <label for="ketinggianInput">Ketinggian (meter):</label>
        <input type="number" id="ketinggianInput" placeholder="Masukkan ketinggian">
        <label for="jamInput">format: 2023-01-15T12:00:00</label>
        <input type="text" id="jamInput" placeholder="Masukkan Tanggal dan Jam">
        <button onclick="tambahData()">Tambah Data</button>
        <a href="jajal.php">Lihat Grafik</a>
    </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.min.js" integrity="sha384-BBtl+eGJRgqQAUMxJ7pMwbEyER4l1g+O15P+16Ep7Q9Q+zqX6gSbd85u4mG4QzX+" crossorigin="anonymous"></script>
    ...
    function tambahData() {
            ...
            var jam = document.getElementById("jamInput").value;

            if (!isNaN(ketinggian) && jam !== "") {
                var data = {
                ...
                var existingData = JSON.parse(localStorage.getItem("ketinggianData")) || [];
                existingData.push(data);

                // Simpan data ke localStorage
                localStorage.setItem("ketinggianData", JSON.stringify(existingData));
